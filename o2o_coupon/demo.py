...
"""
    ...
    1、特征数据划分                            
               ...
               【dataset3】20160701~20160731        【feature3】20160315~20160630  （测试集）
               【dataset2】20160515~20160615        【feature2】20160201~20160514  （训练集2）
               【dataset1】20160414~20160514        【feature1】20160101~20160413  （训练集1）
    online数据集可以提取到与用户相关的特征，
    offline数据集可以提取到更加丰富的特征：用户相关的特征，商家相关的特征，优惠劵相关的特征，用户-商家交互特征。
...
def dealOtherFeature(dataset3,file_name):
    # dataset3
    t = dataset3[['user_id']]
    ...
    other_feature3.to_csv(file_name, index=None)
    return other_feature3


dealOtherFeature(dataset3,'data/other_feature3.csv')
dealOtherFeature(dataset2,'data/other_feature2.csv')
dealOtherFeature(dataset1,'data/other_feature1.csv')
